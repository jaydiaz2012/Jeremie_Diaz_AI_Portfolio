...
export const metadata: Metadata = {
  title: 'AI Engineer Portfolio | Jeremie Jan Diaz',
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <span className="text-purple-300">jayremie.diaz@gmail.com</span>
                <span className="text-purple-300">https://www.linkedin.com/in/jandiaz/</span>
              </div>
              <div className="text-purple-300">Stay Connected</div>
              <div className="flex gap-4">
                <a href="https://github.com/jaydiaz2012" className="text-purple-400 hover:text-purple-300 transition-colors duration-200">
                ...
                <a href="https://www.linkedin.com/in/jandiaz/" className="text-purple-400 hover:text-purple-300 transition-colors duration-200">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
